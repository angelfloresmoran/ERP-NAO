...
<ul>
  ...
  <main>
    ...
    <h1>Reclutamiento</h1> <br>
            <h4><a href="formAspirante.php" class="a-forms"><img src="./assets/bx-user-plus.svg" alt="">Agregar nuevo aspirante</a></h4>
    ...
    <div class="tabla">
        ...
        <table id="tablax" class="table table-striped table-bordered" style="width:100%">
            ...
            ?>
                ...
                <td>
                <a href="editarAspirante.php?id=<?php echo $row['id']; ?>" class="btn btn-warning"><img src="./assets/bx-edit.svg" alt=""></a>
                <a href="javascript:void(0);" onclick="confirmarEliminacion(<?php echo $row['id']; ?>)"><img src="./assets/bx-trash.svg" alt=""></a>
                </td>
            <?php endwhile ;?>
    ...
    function confirmarEliminacion(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "crud/eliminarAspirante.php?id=" + id;
            }
        });
    }
</script>
