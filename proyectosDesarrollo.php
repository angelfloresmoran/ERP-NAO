...
<ul>
  ...
  <main>
    ...
    <h1>Proyectos</h1> <br>
            <h4><a href="formProyectoDesarrollo.php" class="a-forms"> <img src="./assets/bx-add-to-queue.svg">Crear un nuevo Proyecto</a></h4>
            <h4> <a href="formReporte.php" class="a-forms"><img src="./assets/bxs-file-doc.svg">Subir reporte</a></h4>
            <h4> <a href="historicoProy.php" class="a-forms"><img src="./assets/bx-book.svg" alt="">Historico </a></h4> <br>
    <br><?php
    $area = mysqli_query($conex, "SELECT id, area FROM areadesarrollo WHERE id IN (1,3,4);");
    ?>
            <div>
...
<?php
    ...
    WHERE d.id_Dep = 2 and p.estatusProy IN (1, 3, 6, 7);;");
