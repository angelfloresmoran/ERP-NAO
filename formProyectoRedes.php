...
<body>
  ...
  <main>
    ...
    <div class="row">
    <div class="col-md-12">
      <form action="crud/registrarProyecto.php" method="post" enctype="multipart/form-data">
          ...
          <legend><span class="number">1</span> Información Básica</legend>
            ...
            <label>Team</label>
                ...
                <label>Fecha inicio</label>
                                    <input required class="w3-input w3-border w3-round-xxlarge" name="fechaInicio" type="date">
                                    <label>Fecha fin</label>
                                    <input required class="w3-input w3-border w3-round-xxlarge" name="fechaFin" type="date"></p>
                ...
                <label>Archivo</label>
                <input required class="w3-input w3-border w3-round-xxlarge" name="archivo" id="archivo" type="file">
