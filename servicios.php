...
<body>
    ...
    <div class="barra-lateral">
        <div>
            ...
            <img id="cloud" class="list__img" src="./assets/bx-menu.svg" width="30%"> 
            </div>
        </div>
  ...
  <main>
    ...
    <h1> Servicios contratados</h1> <br>
        <h4><a href="formServiciocontratado.php" class="a-forms"><img src="./assets/bx-add-to-queue.svg">Agregar nuevo servicio</a></h4>
    <div class="tabla">
        ...
        <table id="tablax" class="table table-striped table-bordered" style="width:100%">
            <tr>
             ...
             <?php
                ...
                $consulta = mysqli_query($conex, "SELECT s.id, s.servicio, s.monto, s.tipo, s.fechaContratado, s.fechaTermino, s.observaciones, s.comprobante, t.nombre, s.departamento, d.nombre AS depa FROM serviciocontratado s
            ...
            <tr>
                ...
                <td style="width:90px;"><?php echo $fila['fechaContratado'] ?></td>
                <td style="width:90px;"><?php echo $fila['fechaTermino'] ?></td>
                <td><?php echo $fila['observaciones'] ?></td>
                <td><?php echo $fila['comprobante'] ?></td>
                
                <td><a href="crud/dComprobanteServ.php?id= <?php echo $fila['id'] ;?>" class="btn btn-primary"><img src="./assets/bx-cloud-download.svg" alt=""></a>
                </td>
                <td>
                <a href="editarServicio.php?id=<?php echo $fila['id']; ?>" class="btn btn-warning"><img src="./assets/bx-edit.svg"></a>
