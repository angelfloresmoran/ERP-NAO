...
<ul>
  ...
  <main>
    ...
    <?php
include ("crud/conex.php");
$consul="SELECT * FROM cajachica";
$resul=mysqli_query($conex,$consul);

?>
        <h1>Caja chica</h1>
        <br>
        <h4> <a href="formCajachica.php" class="a-forms"> <img src="./assets/bx-add-to-queue.svg"> Agregar nuevo archivo</a></h4> <br>
        <div> 
    ...
    <div class="tabla-contenido">
        <table id="tablax" class="table table-striped table-bordered" style="width:100%">
            ...
            <tr>
                ...
                <td><a href="crud/dArchivoCaja.php?id= <?php echo $filas['id'] ;?>" class="btn btn-primary"><img src="./assets/bx-cloud-download.svg"></a>
                </td>
                <td>
                <a href="crud/editarCaja.php?id=<?php echo $filas['id']; ?>" class="btn btn-warning"><img src="./assets/bx-edit.svg"></a>
    ...
    function confirmarEliminacion(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "crud/eliminarcaja.php?id=" + id;
            }
        });
    }
</script>
