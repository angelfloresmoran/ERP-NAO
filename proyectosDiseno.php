...
<ul>
  ...
  <main>
    ...
    <h1>Proyectos</h1> <br>
            <h4><a href="formProyectoDiseno.php" class="a-forms"><img src="./assets/bx-add-to-queue.svg">Crear un nuevo Proyecto</a></h4>
        ...
        <?php
            $area = mysqli_query($conex, "SELECT id, area FROM areadesarrollo WHERE id IN (2,7,8,9,10);");
        ?>
...
<table id="tablax" class="table table-striped table-bordered" > 
            ...
            <?php
                ...
                WHERE d.id_Dep = 5 and p.estatusProy IN (1, 3, 6, 7);;");
            ...
            <tr>
                ...
                <td><a href="crud/dArchivosProyectos.php?id= <?php echo $fila['id'] ;?>" class="btn btn-primary"><img src="./assets/bx-cloud-download.svg"></a>
                </td>
                <td>
                <a href="editarProyecto.php?id=<?php echo $fila['id']; ?>" class="btn btn-warning"><img src="./assets/bx-edit.svg"></a>
