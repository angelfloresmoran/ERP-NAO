...
<ul>
  ...
  <main>
    ...
    <?php
    include ("crud/conex.php");
    $consul="SELECT a.id, a.equipo, a.modelo, a.marca, a.estatus, a.cantidad, a.departamento, a.observaciones, e.estatus AS nombreEstatus, m.marca AS nMarca, a.tipo_articulo, tm.tipo, a.unidad_medida, um.unidad  FROM articulo a
    ...
    $tipo = mysqli_query($conex,"SELECT * FROM tipo_material");
    $marca = mysqli_query($conex, "SELECT * FROM marca_material");
    $estatus = mysqli_query($conex, "SELECT * FROM estatusarticulo");
    ?>
        <h1>Inventario</h1>
            
            <h4> <a href="formArticulo.php">Agregar Artículo</a></h4>
            <div>
                <label>Filtrar por Tipo de Material:</label>
                <select id="tipoMaterial">
                <option value="">Mostrar todos</option>
                <?php while ($t = mysqli_fetch_array($tipo)) { ?>
                ...
                <option value="<?php echo $es['estatus']?>"><?php echo $es['estatus']?></option>
                <?php } ?>
                </select> 
        ...
        <div class="tabla-contenido">
            <table id="tablax" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td><?php echo $filas['nMarca'] ?></td>
                    <td><?php echo $filas['modelo'] ?></td>
                    <td><?php echo $filas['nombreEstatus'] ?></td>
                    <td><?php echo $filas['cantidad'] ?></td>
                    <td><?php echo $filas['unidad'] ?></td>
                    <td><?php echo $filas['observaciones'] ?></td>
                    <td>
                        <form action="crud/sumarArticulo.php" style="display:flex" method="post">
                        <input type="hidden" name="id_articulo" value="<?php echo $filas['id']; ?>">
                            <input type="text" style="width:45px" name="cantidadSuma">
                            <button class="button_paloma" type="submit"><img class="paloma" src="img/paloma.png" alt=""></button>
                        </form>
                    </td>
                    
                    <td>
                        <form action="crud/restarArticulo.php" style="display:flex" method="post">
                        <input type="hidden" name="id_articulo" value="<?php echo $filas['id']; ?>">
                            <input type="text" style="width:45px" name="cantidadResta">
                            <button class="button_paloma" type="submit"><img class="paloma" src="img/paloma.png" alt=""></button>
                        </form>
                    </td>

                    <td>
                <a href="editarArticulo.php" class="btn btn-warning"><img src="./assets/bx-edit.svg"></a>
    ...
    <script src="js/filtrarInventario.js"></script>
    <script>
    function confirmarEliminacion(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "crud/eliminarArt.php?id=" + id;
            }
        });
    }
</script>
