...
<body>
    ...
    if(isset($_POST['enviar'])){
        ...
        $fecha=$_POST['fechaC'];
        $depa=$_POST['depa'];
        $sql="UPDATE cajachica SET nombre='".$nombre."', descripcion='".$descripcion."',fecha='".$fecha."', departamento='".$depa."'
        WHERE id='".$id."'";
        $arch=(isset($_FILES["archivoC"]['name'])?$_FILES["archivoC"]['name']:"");
        $fecha= new DateTime();
        $nombre_archi=($arch!='')?$fecha->getTimestamp()."_".$_FILES["archivoC"]['name']:"";
        $tmp_archi=$_FILES["archivoC"]['tmp_name'];
    ...
    if ($_FILES['archivoC']['size'] > $limite_tamano) {
        ...
        if($tmp_archi!=''){
            ...
            $sql="UPDATE cajachica SET archivo='".$nombre_archi."' WHERE id='".$id."'";
        }
    ...
    $id=$_GET['id'];
    $sql="SELECT * FROM cajachica WHERE id='".$id."'";
...
<nav>
    ...
    <main>
        <div class="main-content"> 
                ...
                <form action="editarCaja.php" method="post" enctype="multipart/form-data">
                    ...
                    <!------ INPUTS FORMULARIO------>
                        ...
                        <label>Nombre</label>
                        <input class="w3-input w3-border w3-round-xxlarge" name="nombreC" value="<?php echo $nombre; ?>" type="text" required>
                        <label>Descripción</label>
                        <input class="w3-input w3-border w3-round-xxlarge"  name="descripC" value="<?php echo $descripcion; ?>" type="text" required>
                        <label>Fecha</label>
                        <input class="w3-input w3-border w3-round-xxlarge" name="fechaC" value="<?php echo $fecha; ?>" type="date" required>
                        <label>Archivo</label> <br>
                        Documento: <a href="<?php echo "files/$archi"; ?>"><?php echo $archi; ?></a> 
                        <p><input type="file" name="archivoC"></p>
                        ...
                        <div class="register-btn">
                            <a href="../cajachica.php" class="button-57"><img src="../assets/bx-arrow-back.svg"></a>

                            <button type="submit" class="button" name="enviar" style="vertical-align:middle"><span>Actualizar</span></button>
                        </div>                                                
                    </div>
