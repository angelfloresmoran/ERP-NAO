...
if (isset($_FILES['archivo'])) {
    ...
    if ($_FILES['archivo']['size'] > $limite_tamano) {
        ...
        header("location:../formGastosProyecto.php"); 
        exit;
    }
        ...
        if (move_uploaded_file($_FILES["archivo"]["tmp_name"], $carpeta_destino . $nombre_archivo)) {
            ...
            $sql = "INSERT INTO gastosproy (nombre, descripcion, fecha, proyecto, archivo) 
            VALUES ( '$nombre', '$desc', '$fecha', '$proy', '$nombre_archivo')";
