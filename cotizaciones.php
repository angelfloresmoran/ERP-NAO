...
<ul>
  ...
  <main>
    ...
    <?php
include ("crud/conex.php");
$consul="SELECT * FROM cotizacion";
$resul=mysqli_query($conex,$consul);

?>
        <h1>Cotizaciones</h1>
        <br>
        <h4> <a href="formCotizacion.php" class="a-forms"> <img src="./assets/bx-add-to-queue.svg"> Agregar nueva cotización</a></h4> <br>
        <div> 
    ...
    <div class="tabla-contenido">
        ...
        <table id="tablax" class="table table-striped table-bordered" style="width:100%">
            ...
            <tr>
                ...
                <td><a href="crud/dArchivosCotizacion.php?id= <?php echo $filas['id'] ;?>" class="btn btn-primary"><img src="./assets/bx-cloud-download.svg"></a>
                </td>
                <td>
                <a href="crud/editarCoti.php?id=<?php echo $filas['id']; ?>" class="btn btn-warning"><img src="./assets/bx-edit.svg"></a>
    ...
    function confirmarEliminacion(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "crud/eliminarCoti.php?id=" + id;
            }
        });
    }
</script>
