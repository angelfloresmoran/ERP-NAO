...
<head>
    ...
    <title>Agregar Corte Caja Chica</title>
...
<body>
  ...
  <main>
    ...
    <div class="row">
    <div class="col-md-12">
      <form action="crud/registrarCaja.php" method="post" enctype="multipart/form-data">
      ...
      <?php
        ...
        <fieldset>
          ...
          <textarea cols="30" rows="5" name="descripC" required></textarea>
          ...
          <label>Archivo:</label>
          <input type="file" name="archivoC" required>
