...
<body>
  ...
  <main>
    ...
    <div class="col-md-12">
      ...
      <form action="crud/registrarAspirante.php" method="post" enctype="multipart/form-data">
       ...
       <?php
        ...
        <fieldset>
          ...
          <input type="text" name="nombre-Aspirante">

          <label>Número de teléfono:</label>
          <input type="number" name="telefono-Aspirante">
          ...
          <BR><label>Comprobante de domicilio:</label>
          <input type="file" name="comprobante-domicilio-Aspirante"></BR>

          <BR><label>Certificado:</label>
          <input type="file" name="certificado-Aspirante"></BR>

          <BR><label>Carta de recomendación:</label>
