...
<ul>
  ...
  <main>
    ...
    <h1>Requisiciones</h1> <br>
        ...
        <h4> <a href="formRequisicion.php" class="a-forms"> <img src="./assets/bx-add-to-queue.svg"> Agregar nueva requisición</a></h4> <br>
        <div> 
    ...
    <div class="tabla-contenido">
        ...
        <table id="tablax" class="table table-striped table-bordered" style="width:100%">
            ...
            <?php
                ...
                include ("crud/conex.php");
                $consulta = mysqli_query($conex, "SELECT * FROM requisiciones");
            ...
            <tr>
                ...
                <td><a href="crud/dArchivosRequisiciones.php?id= <?php echo $fila['id'] ;?>" class="btn btn-primary"><img src="./assets/bx-cloud-download.svg"></a>
                </td>
                <td>
                <a href="crud/editarRequi.php?id=<?php echo $fila['id']; ?>" class="btn btn-warning"><img src="./assets/bx-edit.svg"></a>
    ...
    function confirmarEliminacion(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "crud/eliminarRequi.php?id=" + id;
            }
        });
    }
</script>
