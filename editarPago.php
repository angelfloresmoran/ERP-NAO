...
include ("crud/conex.php");
$proyecto = mysqli_query($conex,"SELECT id, nombre FROM proyectos");
...
<body>
    ...
    <?php
        include ("crud/conex.php");
        $consulta = mysqli_query($conex, "SELECT g.id, g.nombre AS nombre_gasto, g.descripcion, g.fecha, g.archivo, g.proyecto, p.nombre AS nombre_proy FROM gastosproy g 
        JOIN proyectos p ON g.proyecto = p.id;" );
 ...
 <?php
  ...
  <main>
    ...
    <div class="row">
    <div class="col-md-12">
      <form action="crud/editarPago.php" method="post" enctype="multipart/form-data">
        <h1> Nuevo archivo</h1>
        ...
        <fieldset>
          ...
          <label>Nombre:</label>
          <input required name="nombre" type="text" value="<?php echo $fila['nombre_gasto']; ?>">
        
          <label>Descripción:</label>
          <textarea required cols="30" rows="5"  name="desc" value="<?php echo $fila['descripcion']; ?>"><?php echo $fila['descripcion']; ?></textarea>

          <label>Fecha:</label>
          <input required name="fecha" type="date" value="<?php echo $fila['fecha']; ?>">

          <label>Proyecto</label>
                                    
                <label class="select" for="slct">
                <select id="slct" required="required" name="proy">
                    <option value="<?php echo $fila['proyecto']; ?>" selected="selected"><?php echo $fila['nombre_proy']?></option>
                ...
                <input required class="w3-input w3-border w3-round-xxlarge" name="archivoAct" type="text" value="<?php echo $fila['archivo']; ?>">
                <a href="crud/files/<?php echo $fila['archivo']; ?>" target="_blank">Ver archivo actual</a> <br> <br>
