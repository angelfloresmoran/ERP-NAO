...
<ul>
  ...
  <main>
    ...
    <h1>Proyectos</h1> <br>
            <h4><a href="formProyectoRedes.php" class="a-forms"><img src="./assets/bx-add-to-queue.svg" >Crear un nuevo Proyecto</a></h4>
            <h4> <a href="formReporte.php" class="a-forms"><img src="./assets/bxs-file-doc.svg">Subir reporte</a></h4>
            <h4> <a href="historicoProy.php" class="a-forms"><img src="./assets/bx-book.svg">Historico</a></h4><br>
    
    <?php
    $area = mysqli_query($conex, "SELECT id, area FROM areadesarrollo WHERE id IN (11);");
    ?>
            <div>
...
<?php
    include ("crud/conex.php");
    $consulta = mysqli_query($conex, "SELECT p.id, p.nombre AS nombre_proy, p.fechaInicio, p.fechaFin, p.descripcion, p.archivo, p.estatusProy, p.team, p.areaDesarrollo, p.cliente, e.estatus, t.nombre AS nombre_team, a.area, c.nombreEmpresa, d.nombre, a.area FROM proyectos p 
    ...
    WHERE d.id_Dep = 3 and p.estatusProy IN (1, 3, 6, 7);;");
...
<tr>
    ...
    <td><a href="crud/dArchivosProyectos.php?id= <?php echo $fila['id'] ;?>" class="btn btn-primary"><img src="./assets/bx-cloud-download.svg" alt=""></a>
    </td>
    <td>
    <a href="editarProyecto.php?id=<?php echo $fila['id']; ?>" class="btn btn-warning"><img src="./assets/bx-edit.svg" alt=""></a>
    <a href="javascript:void(0);" onclick="confirmarEliminacion(<?php echo $fila['id']; ?>)"><img src="./assets/bx-trash.svg" alt=""></a>
    </td>
