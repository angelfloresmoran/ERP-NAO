...
<ul>
  ...
  <main>
    ...
    <div class="main-content"> 
        <?php
            include ("crud/conex.php");
            $consul="SELECT * FROM cliente";
            $resul=mysqli_query($conex,$consul);
        ?>
            
            <h1>Clientes</h1>
            
            <h4> <a href="formCliente.php" class="a-forms"> <img src="./assets/bx-add-to-queue.svg" alt="">Agregar cliente nuevo</a></h4>
            <div class="tabla">
            ...
            <table id="tablax" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td><?php echo $filas['nombreRep'] ?></td>
                    
                <td>
                <a href="crud/editarCliente.php?id=<?php echo $filas['id']; ?>" class="btn btn-warning"><img src="./assets/bx-edit.svg"></a>
    ...
    function confirmarEliminacion(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "crud/eliminarCliente.php?id=" + id;
            }
        });
    }
</script>
