...
<body>
  ...
  <main>
    ...
    <div class="col-md-12">
      ...
      <form action="crud/registrarArticulo.php" method="post">
      ...
      <?php
        ...
        <fieldset>
          ...
          <label>Equipo:</label>
          <input type="text" name="equi" type="text" placeholder="Impresora, computadora, destornillador, etc.">
        
          <label>Marca:</label>
          <input name="marca" type="text" placeholder="EPSON, HP, Trupper, etc">

          <label >Modelo:</label>
          <input name="modelo" type="text" placeholder="Modelo del equipo">
          ...
          <select id="slct" required="required" name="sta">
            ...
            <textarea cols="30" rows="5" name="obs"></textarea>
        </fieldset>
