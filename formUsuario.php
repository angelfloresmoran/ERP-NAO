    ...
    <div class="col-md-12">
      ...
      <!--------------------Alertas Formulario--------------------------->     
        ...
        <fieldset>
          ...
          <input required type="number" name="tel">
        ...
        <fieldset>  
          ...
          <input required type="text" name="aPaterno">

          <label>Apellido Materno:</label>
          <input required type="text" name="aMaterno">

          <label>Fecha de nacimiento:</label>
          <input required type="date" name="fechaN">

          
        
       
          <legend><span class="number">3</span> Información para el Sistema</legend>

          <label>Inicio del contrato:</label>
          <input required type="date" name="fechaI">

          <label>Termino del contrato:</label>
          <input required type="date" name="fechaF">

          <label>Salario:</label>
          <input required type="text" name="salario">

          <label for="job">Modalidad:</label>
          ...
          <label class="select" for="slct">Rol:</label>
          ...
          <label class="select" for="slct">Departamento:</label>
         ...
         <label class="select" for="slct">Seguro:</label>
          ...
          <label>Modulos:</label>
                        <?php
                             while ($mod = mysqli_fetch_assoc($modulo)) {
                                echo '<input type="checkbox" name="modulos[]" value="' . $mod['id'] . '"> ' . $mod['modulo'] . '<br>';
                            }
                        ?> <br>
        ...
        <button type="submit" class="button" style="vertical-align:middle">Guardar</button>
