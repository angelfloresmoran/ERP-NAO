...
<body>
  ...
  <main>
    ...
    <div class="row">
    <div class="col-md-12">
      <form action="crud/registrarFact.php" method="post" enctype="multipart/form-data">
      ...
      <?php
        ...
        <fieldset>
          ...
          <label>Nombre:</label>
          <input name="nombreFac" type="text">
        
          <label>Descripción:</label>
          <textarea cols="30" rows="5"  name="descFac"></textarea>

          <label>Fecha:</label>
          <input name="fechaFac" type="date">
