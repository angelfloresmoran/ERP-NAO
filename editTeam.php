    ...
    <div class="col-md-12">
      ...
      <form>
        ...
        <fieldset>
          ...
          <legend><span class="number">1</span> Información General</legend>
        
          <label>Nombre:</label>
          <input type="text" name="nombreTeam">

          <label>Descripción:</label>
          <textarea name="descTeam" id="" cols="30" rows="10"></textarea>

          <label>Agregar Usuarios:</label>
          <?php
            $inc = include ('crud/conex.php');
            if ($inc){
                ...
                if ($resultado){
                    while ($row = $resultado->fetch_array()){
                        ...
                        echo '<input type="checkbox" name="" value=""' . $nombre . $aPaterno . $aMaterno;
                    ?>
                    <h5> <?php echo $nombre; ?> <?php echo $aPaterno; ?> <?php echo $aMaterno; ?></h5> <br>
                    <?php   
                    }
                }
            }
        ...
        <a href="teams.php"><img src="./assets/bx-arrow-back.svg"></a>
