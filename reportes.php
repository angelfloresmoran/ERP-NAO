...
<ul>
  ...
  <main>
    ...
    <h1>Reportes</h1><br>
        <h4> <a href="formReporte.php" class="a-forms"><img src="./assets/bxs-file-doc.svg">Subir reporte</a></h4> <br>
        <div> <br>
 ...
 <!---------------------------FIN ALERTAS------------------------------------------------>     
    ...
    <div class="tabla-contenido">
            ...
            <?php
                ...
                $consulta = mysqli_query($conex, "SELECT r.id, r.nombre AS nombre_reporte, r.fecha, r.archivo, r.proyecto, p.nombre AS nombre_proy FROM reporte_proyecto r JOIN proyectos p ON r.proyecto = p.id ORDER BY r.fecha DESC;" );
                while ($fila = mysqli_fetch_assoc($consulta)):


            ?>
            <tr>
                <td><?php echo $fila['nombre_reporte'] ?></td>
                <td><?php echo $fila['nombre_proy'] ?></td>
                <td><?php echo $fila['fecha'] ?></td>
                <td><?php echo $fila['archivo'] ?></td>
                
                <td><a href="crud/dArchivosReportes.php?id= <?php echo $fila['id'] ;?>" class="btn btn-primary"><img src="./assets/bx-cloud-download.svg"></a>
                </td>

                <td>
                <a href="editarReporte.php?id=<?php echo $fila['id']; ?>" class="btn btn-warning"><img src="./assets/bx-edit.svg"></a>
