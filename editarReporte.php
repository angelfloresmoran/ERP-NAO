      ...
      <?php
        ...
        <fieldset>
          ...
          <input type="hidden" name="id" value="<?php echo $reporte['id']; ?>">
                        ...
                        <input name="nombre" type="text" value="<?php echo $reporte['nombre']; ?>" placeholder="Nombre del Reporte">
                        <label>Fecha</label>
                        <input type="date" name="fecha" value="<?php echo $reporte['fecha']; ?>">
                        <label>Nombre del proyecto</label>
                                    ...
                                    <br><input name="archivoAct" type="text" value="<?php echo $reporte['archivo']; ?>">
                                    
                                    
                                    <label>Archivo Nuevo:</label>
                                    <input name="archivoNuevo" id="archivoNuevo" type="file">
        

        </fieldset>
       <a href="reportes.php"><img src="./assets/bx-arrow-back.svg"></a>
