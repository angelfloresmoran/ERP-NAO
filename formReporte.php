...
<body>
  ...
  <main>
    ...
    <div class="row">
    <div class="col-md-12">
      <form action="crud/reporteProyecto.php" method="post" enctype="multipart/form-data">
      ...
      <?php
        ...
        <fieldset>
          ...
          <legend><span class="number">1</span>Datos</legend>
            ...
            <input required class="w3-input w3-border w3-round-xxlarge" name="nombre" type="text" placeholder="nombre_archivo">
                        
            <label>Fecha</label>
            <input required class="w3-input w3-border w3-round-xxlarge" type="date" name="fecha">
