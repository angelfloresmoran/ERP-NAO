...
<body>
  ...
  <main>
    ...
    <div class="col-md-12">
      ...
      <form action="crud/registrarRequisicion.php" method="post" enctype="multipart/form-data">
      ...
      <?php
        ...
        <label>Nombre</label>
        <input required class="w3-input w3-border w3-round-xxlarge" name="nombre" type="text" placeholder="nombre">
                        
        <label>Descripción</label>
        <textarea required name ="desc" type="text" placeholder="breve descripción" cols="30" rows="5"></textarea>
        
                        
        <label>Fecha</label>
        <input required class="w3-input w3-border w3-round-xxlarge" name="fecha" type="date">
