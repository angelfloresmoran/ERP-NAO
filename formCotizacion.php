...
<head>
    ...
    <title>Agregar Cotizaciones</title>
...
<body>
  ...
  <main>
    ...
    <div class="row">
    <div class="col-md-12">
      <form action="crud/registrarCotizacion.php" method="post"  enctype="multipart/form-data">
      ...
      <?php
        ...
        <fieldset>
          ...
          <label>Nombre:</label>
          <input type="text" name="cotiNom">
        
          <label>Descripción:</label>
          <textarea cols="30" rows="5" name="dsc" required></textarea>
